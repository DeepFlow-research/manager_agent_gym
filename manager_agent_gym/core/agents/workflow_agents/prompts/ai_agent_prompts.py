...
- **Resources**: Generated deliverables (with clear names, descriptions, and content)
- **Reasoning**: Your thought process and key decisions
- **Quality Assessment**: Self-evaluation on a scale of 0-5
- **Confidence Level**: Your confidence in the result (0-1)
