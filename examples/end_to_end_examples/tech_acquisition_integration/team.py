...
def create_tech_acquisition_team_configs():
    ...
    tech_due_diligence_lead = AIAgentConfig(
        ...
        agent_description=(
            "Technical diligence lead who converts complex systems into a clear risk map and integration plan."
        ),
        agent_capabilities=[
            "Assesses architecture and code quality",
            "Evaluates cybersecurity and scalability",
            "Quantifies technical debt and risks",
            "Drafts integration complexity mapping",
        ],
    )
    ...
    business_analyst = AIAgentConfig(
        ...
        agent_capabilities=[
            "Validates ARR/churn/CAC/LTV",
            "Analyzes customer contracts",
            "Assesses revenue sustainability",
            "Maps operational workflows",
        ],
    )
    ...
    financial_analyst = AIAgentConfig(
        ...
        agent_description=(
            "Financial analyst who connects market reality to projections and valuation drivers."
        ),
        agent_capabilities=[
            "Verifies projections and assumptions",
            "Sizes market and competition",
            "Builds valuation sensitivity analyses",
            "Flags key financial risks",
        ],
    )
    ...
    systems_integration_architect = AIAgentConfig(
        ...
        agent_description=(
            "Architect who designs pragmatic integration roadmaps and de‑risks migrations."
        ),
        agent_capabilities=[
            "Designs compatibility and roadmaps",
    ...
    cybersecurity_specialist = AIAgentConfig(
        ...
        agent_description=(
            "Security specialist who identifies material risks early and proposes workable mitigations."
        ),
        agent_capabilities=[
            "Conducts security audits and gap analysis",
            "Verifies privacy/compliance posture",
            "Designs integration security protocols",
    ...
    regulatory_counsel = HumanAgentConfig(
        ...
        agent_capabilities=[
            "Advises on HSR strategy and filings",
            "Interfaces with regulators",
            "Coordinates timelines and waiting periods",
    ...
    data_privacy_officer = HumanAgentConfig(
        ...
        agent_description=(
            "Privacy lead who ensures lawful data handling across both orgs during diligence and integration."
        ),
        agent_capabilities=[
            "Reviews DPAs and data transfers",
            "Sets minimization and access rules",
    ...
    ip_legal_specialist = HumanAgentConfig(
        ...
        agent_description=(
            "IP specialist who secures chain‑of‑title and workable licensing for the combined company."
        ),
        agent_capabilities=[
            "Validates IP ownership and OSS",
            "Drafts IP/OSS schedules",
            "Advises on consents/assignments",
    ...
    financial_controller = HumanAgentConfig(
        ...
        agent_description=(
            "Controller who keeps numbers reliable across purchase accounting and integration."
        ),
        agent_capabilities=[
            "Oversees acquisition accounting",
            "Runs budget/synergy tracking",
            "Aligns reporting and controls",
            "Approves integration steps",
        ],
    )
    ...
    chief_technology_officer = HumanAgentConfig(
        ...
        agent_description=(
            "Technology leader who sets integration vision and de‑risks transitions."
        ),
        agent_capabilities=[
            "Approves architecture decisions",
            "Allocates technical resources",
            "Chairs design reviews",
            "Resolves high‑impact risks",
        ],
    )
    ...
    target_company_ceo = HumanAgentConfig(
        ...
        agent_description=(
            "Target leader who keeps talent engaged and customers supported during transition."
        ),
        agent_capabilities=[
            "Coordinates employee communications",
            "Supports customer continuity",
            "Aligns leadership transition",
            "Confirms disclosure accuracy",
        ],
    )
